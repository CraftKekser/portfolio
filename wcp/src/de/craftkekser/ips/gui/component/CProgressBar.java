...
public class CProgressBar extends JProgressBar{
	...
	public void paint(Graphics g) {
		...
		LinearGradientPaint gradient1 = new LinearGradientPaint(new Point2D.Float(0, 0), new Point2D.Float(0, h), new float[] {0, 0.3F, 0.7F, 1}, new Color[] {getForeground(), getForeground().darker(), getForeground().darker(), getForeground()});
